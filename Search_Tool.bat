@REM - Search_Tool.BAT (11 Apr 2025 // 14 Apr 2025): Simple Batch File to Search Files and Contents -- v1.0.2
@REM - Original Message: https://www.reddit.com/user/OffTheClockStudios/comments/1jxvw0b/simple_batch_file_to_search_files_and_contents/
@ECHO OFF
 setlocal
